...
if (
    ...
    echo "<div class='container exitoLogin'>";
    echo "<div class='h-100 row align-items-center'>";
    echo "!Has iniciado sesión con éxito! <i class='fas fa-smile-beam emoji'></i><br/>";
    echo "Puedes acceder a tu <a href='index.php?option=usuario'>Perfil</a> o dirigirte a <a href='index.php?option=home'>Inicio</a>";
    echo "</div>";
    echo "</div>";
} else {
